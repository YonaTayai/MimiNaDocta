...
<body style="background-image: url('../images/hosptbg.jpg');">
    ...
    <h3 class="w3-center">Book for Doctor</h3>   
    <hr>
    <form action="adminActform.php" method="POST" onsubmit="formValidation();"  >
      ...
      <div class="w3-row mt-4 w3-row-padding">
        <div class="w3-third w3-left-bar l4">
          <label class="font">Date Of Appointment:</label>
    ...
    if ($result->num_rows >0) {
      ...
      <tr class="w3-center">
        ...
        <td class=" w3-row-padding">
          <a class="btn w3-teal" href=" edidel.php?id=<?php echo $rows['scheduleID'] ?>">Edit</a>
          <a class="btn w3-red" href="">Delete</a>
        </td>
      </tr>     
        <?php
      }
